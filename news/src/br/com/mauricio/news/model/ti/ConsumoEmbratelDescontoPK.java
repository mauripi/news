...
public class ConsumoEmbratelDescontoPK implements Serializable{

	private static final long serialVersionUID = 1L;
	private String fatura;
	private Integer sequencia;
	
	public ConsumoEmbratelDescontoPK() {}
	...
	public boolean equals(Object obj) {
		...
		if (getClass() != obj.getClass())
			return false;
		ConsumoEmbratelDescontoPK other = (ConsumoEmbratelDescontoPK) obj;
		if (fatura == null) {
