...
import br.com.mauricio.news.ln.marketing.ImportaIbopeLN;

@ManagedBean(name="importaibopeMB")
@ViewScoped
public class ImportaIbopeBean implements Serializable{
    ...
    public void importar(){
    	if(is!=null){
    		ImportaIbopeLN ln = new ImportaIbopeLN();    
